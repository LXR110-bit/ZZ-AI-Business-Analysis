...
const EXPECTED_VERSION = process.env.EXPECTED_VERSION || '1.1.0';
const EXPECTED_WEEKS = (process.env.TARGET_WEEKS || '2026-W18,2026-W19,2026-W20,2026-W21,2026-W22,2026-W23,2026-W24,2026-W25,2026-W26,2026-W27')
  .split(',')
  .map((w) => w.trim())
  .filter(Boolean);
