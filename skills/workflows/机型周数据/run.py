...
def main() -> int:
    ...
    ap.add_argument("--base-target-map", type=str, default=str(BASE_TARGETS_PATH), help="用户已建 Base 目标映射 JSON; 默认读取私有 base_targets.json 或 MODEL_WEEKLY_BASE_TARGET_MAP（仓库仅提供 example）")
