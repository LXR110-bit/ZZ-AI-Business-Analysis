...
select
    ...
    case when a.stat_date between date_sub(next_day(date_sub('${outFileSuffix}', 7), 'MON'),7) and date_sub(next_day(date_sub('${outFileSuffix}', 7), 'MON'),1) then 7
         when a.stat_date between next_day(date_sub('${outFileSuffix}', 7), 'MON') and '${hiveconf:run_dt}' then datediff('${hiveconf:run_dt}',next_day(date_sub('${outFileSuffix}', 7), 'MON'))+1
    ...
    -- count(distinct a.stat_date) as day_cnt
